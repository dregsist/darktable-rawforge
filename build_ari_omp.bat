...
echo Building test_ari.exe with /openmp ...
"%CL_PATH%" /nologo /O2 /openmp /TC /W3 /I"%MSVC_INC%" /I"%SDK_UCRT_INC%" /I"%SDK_UM_INC%" /I"%SDK_SH_INC%" /I"%WORK%" test_ari.c /Fe:test_ari.exe /link /LIBPATH:"%MSVC_LIB%" /LIBPATH:"%SDK_UCRT_LIB%" /LIBPATH:"%SDK_UM_LIB%"
